...
Config.boatShops = {
    lagras = {
        ...
        boats = { -- Change ONLY These Values: boatName, buyPrice, sellPrice and transferPrice
            ...
            pirogue        = { boatName = "Pirogue Canoe",  boatModel = "pirogue",        buyPrice = 50,   sellPrice = 30,  transferPrice = 15 },
            pirogue2       = { boatName = "Pirogue2 Canoe", boatModel = "pirogue2",       buyPrice = 50,   sellPrice = 30,  transferPrice = 15 },
            rowboat        = { boatName = "Rowboat",        boatModel = "rowboat",        buyPrice = 45,   sellPrice = 15,  transferPrice = 15 },
            rowboatSwamp   = { boatName = "Swamp Rowboat",  boatModel = "rowboatSwamp",   buyPrice = 60,   sellPrice = 20,  transferPrice = 15 },
            keelboat       = { boatName = "Keelboat",       boatModel = "keelboat",       buyPrice = 400,  sellPrice = 250, transferPrice = 15 },
            boatsteam02x   = { boatName = "Steamboat",      boatModel = "boatsteam02x",   buyPrice = 900, sellPrice = 350, transferPrice = 15 },
        },
    },
    saintdenis = {
        ...
        boats = {
            canoetreetrunk = { boatName = "Dugout Canoe",   boatModel = "canoetreetrunk", buyPrice = 45,   sellPrice = 15,  transferPrice = 15  },
            rowboat        = { boatName = "Rowboat",        boatModel = "rowboat",        buyPrice = 45,   sellPrice = 15,  transferPrice = 15 },
            rowboatSwamp   = { boatName = "Swamp Rowboat",  boatModel = "rowboatSwamp",   buyPrice = 60,   sellPrice = 15,  transferPrice = 15 },
            keelboat       = { boatName = "Keelboat",       boatModel = "keelboat",       buyPrice = 400,  sellPrice = 250, transferPrice = 15 },
            boatsteam02x   = { boatName = "Steamboat",      boatModel = "boatsteam02x",   buyPrice = 900, sellPrice = 350, transferPrice = 15 },
        },
    },
    ...
    --vector3(881.88031, -1776.697, 40.228984)
    rhodes = {
    ...
    quakercove = {
        ...
        shopClose = 21,
        boats = {
            --canoetreetrunk = { boatName = "Dugout Canoe",   boatModel = "canoetreetrunk", buyPrice = 45,   sellPrice = 15,  transferPrice = 15  }, this is a personal garage, only a stored boat can be here, none can be buyable here.
            --rowboat        = { boatName = "Rowboat",        boatModel = "rowboat",        buyPrice = 45,   sellPrice = 15,  transferPrice = 15 },
            --rowboatSwamp   = { boatName = "Swamp Rowboat",  boatModel = "rowboatSwamp",   buyPrice = 60,   sellPrice = 15,  transferPrice = 15 },
            --keelboat       = { boatName = "Keelboat",       boatModel = "keelboat",       buyPrice = 800,  sellPrice = 250, transferPrice = 15 },
            --boatsteam02x   = { boatName = "Steamboat",      boatModel = "boatsteam02x",   buyPrice = 1200, sellPrice = 350, transferPrice = 15 },
        },
    },
}
